...
# dir name
export DESIGN_NICKNAME = a2o_lq
# module name
export DESIGN_NAME = lq
...
export VERILOG_FILES = $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_rlmreg_p.v) \
							  ...
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_regk*.v) \
							  ...
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_xnor*.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_xor*.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_aoi*.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_oai*.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_addrcmp.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_rot16*.v) \
							  ...
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_lq*.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/work/lq*.v) \
                       $(VERILOG_FILES_BLACKBOX)

export SDC_FILE      = $(DESIGN_DIR)/constraint.sdc

export DIE_AREA =   0  0   3500   5500
export CORE_AREA = 10 10   3490   5490
