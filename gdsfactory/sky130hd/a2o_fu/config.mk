...
# dir name
export DESIGN_NICKNAME = a2o_fu
# module name
export DESIGN_NAME = fu
...
export VERILOG_FILES = $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_rlmreg_p.v) \
							  ...
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_slat_scan.v) \
							  ...
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_oa*.v) \
							  ...
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_fu_csa*.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_fu_tbl*.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_fu_mul_bthmux*.v) \
							  ...
							  $(wildcard $(DESIGN_DIR)/verilog/trilib/tri_parity*.v) \
							  $(wildcard $(DESIGN_DIR)/verilog/work/fu*.v) \
